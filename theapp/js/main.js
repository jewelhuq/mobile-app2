var  domain ="http://flexiload";
 function check(){
         
		 var un = document.getElementById('username').value;
		 var action = 'check';
$.getJSON(domain+'/login.php?callback=?','un='+un+'&action='+action,function(res){
  ...
  //document.write('<b>'+res.status+'</b><br>');
   document.getElementById('result').innerHTML = '<b>'+res.status+'</b>';
    ...
    $.getJSON(domain+'/index.php?callback=?','username='+un+'&password='+pw+'&action='+action,function(res){
    ...
    $.getJSON(domain+'/index.php?callback=?','em='+em+'&action='+action,function(res){
